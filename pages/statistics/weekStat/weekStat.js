...
Page({
  ...
  onLoad: function (options) {
    ...
    app.basedata.getSysDate(function (res) {
      ...
      var begDate = new Date(now.getYear()<2000?now.getYear() + 1900 : now.getYear(), now.getMonth(), now.getDate() - now.getDay())
      var endDate = new Date(now.getYear() < 2000 ? now.getYear() + 1900 : now.getYear(), now.getMonth(), now.getDate() + (6 - now.getDay())); 
